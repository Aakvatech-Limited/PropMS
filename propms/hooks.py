...
fixtures = ["Custom Field", "Custom Script", "Property Setter", "Print Format",{"doctype":"Naming Series", "filters": [{"doctype":"Daily Checklist"}]}, 'Workflow', 'Workflow State', 'Workflow Action', {"doctype":"Notification", "filters": [{"is_standard":0}]}, 'Auto Email Report', "Transalation" ]
